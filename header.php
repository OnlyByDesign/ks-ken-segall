			...
			?>
				<div class="logo_container">
					...
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<span class="ks-header-title" id="logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>"><?php echo esc_html( get_bloginfo( 'name' ) ); ?></span>
                        <span class="ks-header-desc" id="logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>"><?php echo esc_html( get_bloginfo( 'description' ) ); ?></span>
					</a>
				</div>
